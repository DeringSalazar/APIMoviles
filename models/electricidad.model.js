    ...
    async getAllElectricidad() {
        ...
        async getElectricidad(productId) {
            try {
                ...
                console.error('Error en getElectricidad:', error);
                throw error;
            }
        }

        async getElectricidadPdfPage(productId) {
            try {
                const { rows } = await pool.query(`
                    SELECT 
                        prod ->> 'id' AS product_id,
                ...
                console.error('Error en getElectricidadPdfPage:', error);
                throw error;
            }
        }
    }

    module.exports = new Electricidad();